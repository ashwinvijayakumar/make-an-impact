const events = [
  { year: '2006 - Entrepreneur @ Afflatus Techtronics', text: 'Founded a startup | Employed two engineers | Cash-flow positive | Unable to scale - folded it!' },
  ...
  { year: '20xx - Entrepreneur @ Stealth Startup', text: "Back to startup grassroots! This time, plan for scale!" }
];
