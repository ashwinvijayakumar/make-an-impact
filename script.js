const events = [
  ...
  { year: '2017 - Developer Evangelist @ Intel Movidius', text: "1 of 15 member team that built Intel Neural Compute Stick (NCS), world's first AI accelerator on a USB stick | Built & scaled developer ecosystem for NCS!" },
  ...
  { year: '2022 - Product Manager @ Intel CCG/NUC-G', text: "Incubated NUCaaS, a software & services offering | Deployed in 13 locations across the Americas & EMEA | Bumped up NUC operating margin to 33%." },
  { year: '2023 - Product Manager @ Intel CCG/NUC-G', text: "Recorded $30M opportunity for NUCaaS | Only $1M realized before NUC-G spin-off to Asus." },
  { year: '2024 - Product Manager @ Intel NEX', text: "Transitioned AWS, Azure and RedHat engagements from NUCaaS to Intel Tiber Edge Infrastructure Manager." },
